#Application to Perform Analysis using Shiny 
...
#ui : dashboard is created based on the following attributes 
#•	Loan amount Rages from 500-350000
#•	Interest Rates: 5.42-23.33
#•	Max on Employment Length
#•	Home Owner:  Rent/Own/Mortgage
#•	Annual Income: 4000-6000000
#Loans : Cashloans vs Revolving Loans
#•	Age: Normal Between 20-69(Few values Above 70 )
#•	Application Status: Repeater/New
                    ...
                    dashboardBody(
                      ...
                      tabItems(
                        ...
                        tabItem(tabName = "Input",
                                h2("Input Details"),
                                fluidRow(
                                  box(title = "Loan Defaulters",
                                      width = 3, background = "light-blue",
                                      radioButtons(inputId = "model",label=h5("Contract Typel"),
                                                   choices = c("Cash loans","Revolving loans"),selected = "Cash loans"),
                                      numericInput("T", label = h5("Target"), value = 1),
                                  ...
                                  box(title = "Select NAME_CONTRACT_STATUS",
                                      height = 130,width = 3, background = "lime",
                                      selectInput(inputId = "NAME_CONTRACT_STATUS",label=h6(""),
                                                  choices = c("Approved","Canceled","Refused","Unused Offer"),selected = "Approved")
                                  ),
...
#server for reactive dashboards based on the interpretation
